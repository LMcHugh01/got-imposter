 ...
 *
 * The standalone Draft game's start screen — same house-naming mechanic
 * as the Campaign game's DraftIntro, just framed around this game's own
 * goal (highest average Overall rating) rather than "then take your
 * house to war," since this game stops at the roster reveal.
 */
    ...
    <div className="w-full max-w-sm flex flex-col gap-8 pt-10 pb-4 text-center">
      <div>
        ...
        <p className="text-stone-500 text-sm mt-4 italic leading-relaxed" style={{ fontFamily: 'EB Garamond, serif' }}>
          Ten seats, five candidates a round. Build the council with the highest average rating you can.
        </p>
      </div>
